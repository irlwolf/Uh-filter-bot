...
BOT_TOKEN = environ.get('BOT_TOKEN', '7798556356:AAHUKj_QbHvHtQCip8YDnj6k2Qk7FWC9kss')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1302460619').split()]
USERNAME = environ.get('USERNAME', "https://t.me/irlwolf") # ADMIN USERNAME
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'wolfhub')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002452376610'))  # set shortner log channel
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002452376610') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002409821863')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/irlwolfchat') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
